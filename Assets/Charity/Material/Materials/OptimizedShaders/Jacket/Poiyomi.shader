Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/5912d0382f8223e448c3c2aecc935348"
{
	Properties
	{
...
#define PROP_RIMLIGHTCOLORBIAS 0.794
...
#define PROP_MOCHIEMETALLICMULTIPLIER 0.606
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				poiFragData.emission += rim * lerp(poiFragData.baseColor, rimColor, float(0.794)) * rimStrength;
				poiFragData.baseColor = lerp(poiFragData.baseColor, lerp(poiFragData.baseColor, rimColor, float(0.794)) + lerp(poiFragData.baseColor, rimColor, float(0.794)) * rimBrighten, rim);
			}
			#endif
			#ifdef _RIMSTYLE_UTS2
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
