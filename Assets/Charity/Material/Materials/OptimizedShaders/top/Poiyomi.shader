Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/42dbf04a2d213c442bae1a371234dfaa"
{
	Properties
	{
...
#define PROP_SATURATION 0.29
#define PROP_MAINBRIGHTNESS 0.011
...
#define PROP_RIMLIGHTCOLORBIAS 0.422
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				poiFragData.emission += rim * lerp(poiFragData.baseColor, rimColor, float(0.422)) * rimStrength;
				poiFragData.baseColor = lerp(poiFragData.baseColor, lerp(poiFragData.baseColor, rimColor, float(0.422)) + lerp(poiFragData.baseColor, rimColor, float(0.422)) * rimBrighten, rim);
			}
			#endif
			#ifdef _RIMSTYLE_UTS2
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
