Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/d7123c035d96dad44852003434670fe2"
{
	Properties
	{
...
#define PROP_SATURATION -0.08
#define PROP_MAINBRIGHTNESS 0.009
...
#define PROP_EMISSIONSTRENGTH 0.64
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = float(0.64);
