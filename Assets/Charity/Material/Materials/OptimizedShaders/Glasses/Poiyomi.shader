Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/9c95fe8d7d0585447b26a0d848383b5c"
{
	Properties
	{
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + float(-0.234));
				if (float(0))
				{
