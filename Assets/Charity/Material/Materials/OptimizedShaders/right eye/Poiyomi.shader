Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/7d3c11dfa7fa76d4db8be5db4760820d"
{
	Properties
	{
...
#define PROP_RIMLIGHTCOLORBIAS 0.19
...
#define PROPM_END_STENCILPASSOPTIONS 0
			...
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				poiFragData.emission += rim * lerp(poiFragData.baseColor, rimColor, float(0.19)) * rimStrength;
				poiFragData.baseColor = lerp(poiFragData.baseColor, lerp(poiFragData.baseColor, rimColor, float(0.19)) + lerp(poiFragData.baseColor, rimColor, float(0.19)) * rimBrighten, rim);
			}
			#endif
			#ifdef _RIMSTYLE_UTS2
			void ApplyRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
